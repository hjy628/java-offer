 ...
 * @Description: <h1>如果不好好判等，集合存储就会乱套</h1>
 */
...
public class EqualOrElse {
    ...
    private static void equalsAndHashcode(){
        ...
        User user1 = new User("wangdan",22);
        User user2 = new User("wangdan",22);
//        System.out.println(user1.equals(user2));
    ...
    /**
     * <h2>集合元素索引与equals方法相关</h2>
     */
    private static void compareToAndEquals(){
            List<User> users = new ArrayList<>();
            users.add(new User("wangdan",18));
            users.add(new User("wangdan",25));

            User user = new User("wangdan",25);

            Object object;
            int index1 = users.indexOf(user);       //基于equals方法

            int index2 = Collections.binarySearch(users,user);      //基于compareTo方法
